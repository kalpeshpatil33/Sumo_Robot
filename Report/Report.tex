...
\Cref{fig:lcd_wiring} shows the wiring diagram for the LCD. Below snippet shows how our system is run on the robots Arduino board. This keeps writing integer 6 to the XBee.
\newpage
\begin{verbatim}
